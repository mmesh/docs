...
You can easily manage your mmesh workflows via GitOps by enabling the [GitHub integration](/platform/administration/account#gitops).
...
Browse the [Workflow Configuration Reference](/platform/reference/mmesh-workflow.yml) section for information on the workflows YAML file format.
